 ...
 * horário, bônus e as três estreias). Raids: mantidos só Mega Mewtwo X/Y —
 * o evento também roda ~30 chefes de Mega Raid por habitat/horário (Beedrill,
...
export const goFest2026MegaFinale: Evento = {
  ...
  notaCuradoria: {
    texto:
      "Só dá pra escolher um dos três iniciais — vale o Mega Chesnaught: Planta é o tipo mais fraco dos três no plano (\"baixa\", só Roserade/Rillaboom), enquanto Fogo e Psíquico já estão bem resolvidos (Chandelure, Mewtwo Y). O Mewtwo X 4724 e o Mewtwo Y 2387 do plano já são os titulares das megas do fim de semana — não precisa recapturar, só conferir o Passe GO: Mega Finale (31/08–06/09) pela Mega Energia bônus.",
    linkPlano: true,
  },
};
